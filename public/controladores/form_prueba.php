...
<div id="modal_cliente">
    ...
    <form id="form_modal" action="gestion_productos.php" method="post" enctype="multipart/form-data">
        ...
        <input id="modal_idProducto" name="idProducto" type="text" value=""><br><br>
        <span><label for="modal_nombre"><strong>Nombre: </strong></label><input id="modal_nombre" name="nombre" type="text"value=""></span><br><br>
        <span><label for="modal_marca"><strong>Marca: </strong></label><input id="modal_marca" name=marca type="text" value=""></span><br><br>
        <span><label for="modal_categoria"><strong>Categoria: </strong></label><input id="modal_categoria" name="categoria" type="text" value=""></span><br><br>
        <span><label for="modal_precio"><strong>Precio: </strong></label><input id="modal_precio" name="precio" type="text" value=""></span><br><br>
